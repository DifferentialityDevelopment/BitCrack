...
public:
    ...
    virtual void init(const secp256k1::uint256 &start, int compression, const secp256k1::uint256 &stride, bool randomMode = false, const secp256k1::uint256 &end = secp256k1::N - 1) = 0;
